...
//parte 01 operadores relacionais
  ...
  printf("20 > 25 Resultado %d\n", 20 > 25);
  printf("20 < 25  Resultado %d\n", 20 < 25);
  printf("10 >= 5  Resultado %d\n", 10 >= 5);
  printf("10 <= 5 Resultado %d\n", 10 <= 5);
  printf("100 == 100  Resultado %d\n", 100 == 100);
  printf("3 > 3  Resultado %d\n", 3 > 3);
  printf("3  != 50  Resultado %d\n", 50 != 50);
...
//parte 02 operador de modulo e comparacoes
  ...
  printf("15 %% 3  Resultado %d\n", 15 % 3);
  printf("17 %% 5 == 2 Resultado %d\n", 17 % 5);
